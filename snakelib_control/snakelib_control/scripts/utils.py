...
class Robot:
    ...
    def __init__(self, cfgs: Dict = ROBOT_CFGS, robot_name: str = "REU", full_robot: bool = False, num_modules: int = 16):
        ...
        if full_robot:
            if robot_name != "SEA":
                self.end_link = cfgs["end_link"][robot_name] + str(num_modules)
            else:
